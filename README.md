...
特にコロナ禍では、**お店の営業制限や外出自粛**で家で過ごす時間が多く、ダーツへの熱い想いはただただ積もるばかりでした.


そこで僕たちは**自宅でのダーツ環境の構築**に乗り出しました．
しかし，ここで大きな問題に当たります．

**対戦機能のあるダーツ盤は価格が高い**んです！

実は，市販のダーツ盤は主に次の2種類存在します，

1. 点数の計算を行える高機能かつ高額なもの（3万円~）
2. ダーツが刺さるだけで得点計算はできない（3000~5000円前後）

更に，僕たちは市販の高級ダーツ盤にも課題があると考えました．
高級ダーツ盤の取得できる情報は刺さった矢が何点かということで，細かい位置を検出できません．

つまり，だんだん**上達している（刺さるばらつきが小さくなっている）はずなのにそれがスコアは以前低いまま！**
これではせっかくダーツ盤を導入しても**成長が実感できず長続きしません!**

しかも

**自宅という閉じた環境のためなかなか人からアドバイスを貰ったり教えてもらうことは少ない**
...
### 2. **初心者の頃は矢の集弾率が上がってもブル(中心)には入らないため点数が増えず上達を実感しにくい**
### 3. **自宅での練習は上級者の人からアドバイスをもらいにくく，客観視しにくいため上達が難しい**



そこで、私たちはスマホカメラでプレイを撮影することで、例え安い得点計算機能のないダーツ盤であっても、
...
|                    | DartsChart+ 市販ダーツ盤 | 市販ダーツ盤 | 既存の高級ダーツ盤 | 
| ------------------ | ------------------------ | ------------ | ------------------ | 
| 価格               | ¥3000~                   | ¥3000~       | ¥30000~            | 
| 投げて刺さる       | ✅                       | ✅           | ✅                 | 
| スコア計算           | ✅                       | ❌           | ✅                 | 
